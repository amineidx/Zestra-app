  ...
  return (
    <div className="space-y-8 py-8 max-w-2xl mx-auto px-4 md:px-8">
      ...
      <div className="border-b border-border pb-6">
        <span className="text-xs font-semibold tracking-widest text-muted-foreground uppercase">Registry Profile</span>
        <h1 className="text-3xl font-normal tracking-tight text-foreground mt-1">Settings</h1>
        <p className="text-sm text-muted-foreground mt-1">Configure your official business credentials and API keys.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Business details card */}
        <Card className="rounded-lg border border-border shadow-none bg-background overflow-hidden">
          <div className="p-4 bg-muted border-b border-border flex items-center gap-2 text-foreground">
          ...
          <CardContent className="p-6 space-y-4">
            <div className="space-y-1">
              <label className="text-xs uppercase font-medium text-muted-foreground">Official Full Name</label>
              <Input
                required
                value={businessName}
            ...
            <div className="space-y-1">
              <label className="text-xs uppercase font-medium text-muted-foreground">Physical / Mailing Address</label>
              <Input
                value={address}
        ...
        <Card className="rounded-lg border border-border shadow-none bg-background overflow-hidden">
          ...
          <CardContent className="p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-xs uppercase font-medium text-muted-foreground">NIF (Numéro d'Identification Fiscale)</label>
                <Input
                  value={nif}
              ...
              <div className="space-y-1">
                <label className="text-xs uppercase font-medium text-muted-foreground">Auto-Entrepreneur Number</label>
                <Input
        ...
        <Card className="rounded-lg border border-border shadow-none bg-background overflow-hidden">
          ...
          <CardContent className="p-6 space-y-4">
            <div className="space-y-1">
              <label className="text-xs uppercase font-medium text-muted-foreground">API Key</label>
              <Input
                type="password"
                value={geminiApiKey}
            ...
            {/* Warning block */}
            <div className="p-3 bg-accent/50/50 rounded border border-border flex gap-2.5 items-start text-[11px] leading-relaxed text-muted-foreground">
